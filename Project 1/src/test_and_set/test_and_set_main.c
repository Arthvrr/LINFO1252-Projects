#include "test_and_set/test_and_set_main.h"

/*
Fonction qui nous permet d'avoir un main() pour test_and_set 
--> sinon redondance avec les main de test_and_set_philosoph, test_and_set_prod_cons, test_and_set_reader_writer
Fonction utilisée au 2.2 dans test_and_set_perf.sh
*/
